...
Welcome to the contributor guide of Snow Instructor.
...
If you experience bugs or general issues with Snow Instructor, please have a look
...
You can help improve the documentation of Snow Instructor by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/snow-instructor.git
   cd snow-instructor
   ```
